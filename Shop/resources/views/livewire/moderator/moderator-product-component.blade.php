        ...
        <div class="page-header breadcrumb-wrap">
            <div class="container">
                <div class="breadcrumb">
                    <a href="/" rel="nofollow" style="color:white">Strona Głownas</a>
                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <a href="{{route('moderator.product.add')}}" class="btn btn-success float-end">Dodaj Nowy Produkt</a>
                                    </div>
                                </div>
                            </div>
                            <div class="card-body">
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($products as $product)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{route('moderator.product.edit',['product_id'=>$product->id])}}" class="text-info">Edytuj</a>
